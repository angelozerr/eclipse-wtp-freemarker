...
<YYINITIAL, ST_FM_TAG_NAME, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_DECLARATION, ST_XML_ATTRIBUTE_VALUE> {
    {OpenDirectiveStart} | {MacroRefStart} | {CloseDirectiveStart} {
    if(Debug.debugTokenizer)
		dump("\nstart FM tag open");//$NON-NLS-1$
		yybegin(ST_FM_TAG_NAME);
        return FM_TAG_OPEN;
    }
}
...
<ST_FM_BODY, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_PI, ST_XML_PI_EQUALS, ST_XML_PI_ATTRIBUTE_NAME, ST_XML_PI_ATTRIBUTE_VALUE, ST_XML_DECLARATION, ST_XML_DOCTYPE_DECLARATION, ST_XML_ELEMENT_DECLARATION, ST_XML_ATTLIST_DECLARATION, ST_XML_DECLARATION_CLOSE, ST_XML_DOCTYPE_ID_PUBLIC, ST_XML_DOCTYPE_ID_SYSTEM, ST_XML_DOCTYPE_EXTERNAL_ID> {S}* {
	if(Debug.debugTokenizer)
