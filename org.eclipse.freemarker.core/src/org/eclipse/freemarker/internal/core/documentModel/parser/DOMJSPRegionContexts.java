...
public interface DOMJSPRegionContexts extends DOMRegionContext {
	...
	// Freemarker comments regions
	public static final String FM_COMMENT_CLOSE = "FM_COMMENT_CLOSE"; //$NON-NLS-1$
	public static final String FM_COMMENT_OPEN = "FM_COMMENT_OPEN"; //$NON-NLS-1$
	public static final String FM_COMMENT_TEXT = "FM_COMMENT_TEXT"; //$NON-NLS-1$
	...
	/**
	 * Non-taglib XML tag, needing single escape unquoting for embedded
	 * expressions
	 */
